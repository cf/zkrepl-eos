...
function generateRapidUint256Raw(){
  const full_file=`
#pragma once
...
function generateRapidUint256(cfg: VerifierGeneratorConfig): TextFileRecord[]{
  return [{
    name: "rapiduint256.hpp",
    parent_path:`contracts/${cfg.contract_name}/include/${cfg.contract_name}/`,
    content: generateRapidUint256Raw(),
  }];
}
export {
   generateRapidUint256,
}